...
import { getProgram, getPda, toFixedU8_64, u8ToStringTrim, SystemProgram } from "./anchorClient";
...
export default function App() {
  ...
  const handleSave = useCallback(async () => {
    try {
      ...
      await program.methods
        .setName(fixed)
        .accounts({ userData: pda, authority })
        .rpc();
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        {!pubkey ? (
          <button style={styles.btn} onClick={connect}>Connect Phantom</button>
        ) : (
          <div style={styles.row}>
            ...
            <button style={{ ...styles.btn, opacity: generated ? 1 : 0.5 }} onClick={handleSave}>Save</button>
